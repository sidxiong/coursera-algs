...
//        String[] files = new String[]{"heart25.txt", "greeting57.txt", "sedgewick60.txt", "wayne98.txt"};
        String[] files = new String[]{"sedgewick60.txt"};

        for (String f : files) {
            In in = new In("percolation/" + f);      // input file
