...
public class SAPTest {
    ...
    public void length() throws Exception {
        final SAP sap = new SAP(new Digraph(new In("wordnet/digraph-wordnet.txt")));
        ...
        final SAP sap2 = new SAP(new Digraph(new In("wordnet/digraph3.txt")));
        Assert.assertEquals(1, sap2.length(13, 14));
    }
